...
const projects = [
  ...
  {
    title: 'Neuro Symbolic Memory Architecture NIELIT Tezpur',
    ...
    title: 'AI vs Human Music Detection System Tezpur University(Major Project)',
    description: 'Developing a system to differentiate between AI-generated and human-created music using machine learning techniques.',
    imageUrl: web,
  ...
  {
    title: 'Capstone Project 2nd Semester',

...
export default function Hero() {
  ...
  // Animated border squares effect
 useEffect(() => {
  function randomSquare() {
    ...
    return {
      ...
      left: Math.random() * 80 + '%',
      size,
      duration: 4 + Math.random() * 4, // 1.2-2.7s
  ...
  async function spawnSquares() {
    while (running) {
      ...
      // Wait for a random time between 800ms to 1500ms before next square
  ...
  return (
    <section className="modern2025-hero-section">
      ...
      <div className="modern2025-hero-border-squares">
